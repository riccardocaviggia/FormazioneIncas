...
use Northwind
select od.OrderID, p.ProductName, (od.UnitPrice * od.Quantity) as TotaleOrdine
from [Order Details] od
...
use Northwind
select ProductID, coalesce(ProductName, 'Sconosciuto') as NomeProdotto, UnitPrice
from Products
